...
def main():
    ...
    if args.multiprocessing_distributed:
        ...
        print("Utilizing: {MULTIPROCESSING DISTRIBUTED}")
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    print(f" ## Model SPS after GSP: {gsp_model.get_model_sps()[0]:.3f}")
    ...
    print(f" ## Model SPS after Optimization: {gsp_model.get_model_sps()[0]:.3f}")

# print(f"LAYERWISE SPS: {sps_tools.get_layerwise_sps(model)}")
