...
#SBATCH -t 7400
#SBATCH -J rohib
#SBATCH -e ./results/zreports/vgg-cifar100base-%A.err
#SBATCH -o ./results/zreports/vgg-cifar100base-%A.out
#SBATCH -A PSYC0002
...
python main.py --arch vgg19_bn --dataset cifar100 --batch-size 128 --epochs 200 --lr 0.1 \
--lr-drop 80 120 160 --exp-name cifar100/vgg19_bn/baseline
...
# for sps in '0.8'
# do
#     python main.py --arch vgg16 --batch-size 128 --epochs 200 --lr 0.01 --lr-drop 80 120 160 \
...
#     --resume ./results/vgg16_filter/baseline/checkpoint.pth.tar
# done
